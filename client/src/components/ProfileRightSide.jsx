        ...
        {profileData?.resume?.url ? (
          <div className="border border-gray-200 rounded-lg p-4 flex items-center justify-between mb-4 bg-gray-50/50">
            <div className="flex items-center gap-3">
              ...
              <a href={profileData.resume.url} download={profileData.resume.filename || 'Resume.pdf'} target="_blank" rel="noopener noreferrer" className="font-semibold text-gray-800 text-[15px] hover:text-blue-600 transition-colors">
