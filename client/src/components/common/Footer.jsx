      ...
      <div style={{ fontFamily: '"Geist", sans-serif' }} className="w-full relative">
        ...
        <footer className="bg-white w-full text-black pt-6 lg:pt-8 px-4 sm:px-8 md:px-16 lg:px-28">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-12 lg:gap-24">
            ...
            <div className="w-full flex-1 space-y-4">
              ...
              <div className="flex gap-5 md:gap-6 order-1 md:order-2">
                ...
                <a href="https://www.linkedin.com/in/vaibhav-patil13" target="_blank" rel="noopener noreferrer" className="text-neutral-600 hover:text-primary hover:-translate-y-1 hover:scale-110 transition-all duration-300 transform-gpu will-change-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="max-w-7xl mx-auto mt-6 pt-2 border-t border-neutral-300 flex justify-between items-center z-10 relative">
            ...
            <p className="text-sm text-neutral-600 flex items-center justify-center">Built with <Heart className='w-4 h-4 mx-1 text-primary fill-primary' /> by Vaibhav Patil</p>
          </div>
