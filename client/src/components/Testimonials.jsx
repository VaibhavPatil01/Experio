...
export const Testimonials = () => {
  return (
    ...
    <Title title="Build your resume" description="This is the dummy description for the testimonials section. It will be replaced with actual testimonials later." />
    </div>
  )
}
