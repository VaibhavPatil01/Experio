...
export const CallToAction = () => {
  return (
    <div className='border-y border-dashed border-slate-200 w-full max-w-5xl mx-auto px-10 sm:px-16 my-30'>
            <div className="flex flex-col md:flex-row text-center md:text-left items-center justify-between gap-8 px-3 md:px-10 border-x border-dashed border-slate-200 py-16 sm:py-20 -mt-10 -mb-10 w-full">
                <p className="text-xl font-medium max-w-md text-slate-800">Star the repo and join the growing Experio community.</p>
                <a href="https://github.com/VaibhavPatil01/Experio" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 rounded py-3 px-8 bg-primary hover:bg-primary/90 transition text-white">
